...
Launch with: ``nikkecopilot web --db <path> --library <portraits>``
"""
...
def create_app(
    *,
    ...
    """
    app = FastAPI(title="NikkeCopilot")
    ...
    # ``~/Library/Application Support/NikkeCopilot/screenshots/``).
    ...
    def _resolve_screenshot_path(stored: str, mode: Optional[str]) -> Optional[Path]:
        ...
        try:
            project_root = _THIS_DIR.parent.parent.parent  # web/.. = nikke_copilot/.. = src/.. = root
    ...
    def roster_advisor(
        ...
        ``nikkecopilot advisor`` CLI but in the web UI.
        """
